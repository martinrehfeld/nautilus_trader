...
//! [NautilusTrader](http://nautilustrader.io) adapter for
//! [Alpaca Markets](https://alpaca.markets/).
//!
//! The `nautilus-alpaca` crate provides client bindings (HTTP & WebSocket), data
//! models, and helper utilities that wrap the official **Alpaca API**, covering:
//!
