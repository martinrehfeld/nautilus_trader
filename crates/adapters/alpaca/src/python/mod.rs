...
#[pymodule]
pub fn alpaca(_py: Python<'_>, _m: &Bound<'_, PyModule>) -> PyResult<()> {
    // Enums - will be added when pyclass derives are added to enums
    ...
    // WebSocket clients - will be added when pyclass derives are added
