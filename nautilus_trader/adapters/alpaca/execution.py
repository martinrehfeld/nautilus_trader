...
class AlpacaExecutionClient(LiveExecutionClient):
    ...
    def __init__(
        ...
        self._log.info(f"base_url_ws={config.base_url_ws}", LogColor.BLUE)
        ...
        self._log.info(f"max_retries={config.max_retries}", LogColor.BLUE)
    ...
    async def _connect(self) -> None:
        ...
        # TODO: Make this a consequence of a new parameter to AlpacaWebSocketClient.connect
    ...
    def _handle_trade_update(self, data: dict) -> None:
        try:
            ...
            if event_type == "fill":
                filled_at = order_data.get('filled_at') or data.get('timestamp')
